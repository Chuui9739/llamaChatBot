...
# 定義知識庫
knowledge_base = [
    "我們的公司專注於開發智能家居設備，提供包括智能燈光、溫控系統和家庭安全監控等解決方案。",
    "本公司成立於2010年，從最初的小型創業團隊發展成為行業領導者。",
    "我們在全球有多個辦公室，包括美國矽谷、德國柏林和台灣台北。",
    "我們秉持創新、客戶至上和可持續發展的核心價值，致力於推動科技改變生活。",
    "我們為員工提供多元的職業發展途徑，從技術專業到管理職位，並定期進行內部培訓和跨部門交流。",
    "是的，我們每年提供多個實習機會，特別針對大學生和研究生，讓他們可以深入了解科技產業的運作。",
    "我們的產品以用戶友好、無縫整合和高度個性化的智能體驗為競爭優勢。",
    "我們計劃在未來五年內進一步擴展至全球市場，並開發更多與物聯網相關的創新產品。",
    "有的，我們致力於降低碳足跡，並使用可回收材料製造產品，支持可持續發展。",
    "我們提供24/7的客戶支援，並設有專業的技術支援團隊，隨時解決用戶的疑難問題。",
    "我們與多家全球領先的科技公司合作，包括Google和Amazon，並共同開發智能家庭整合系統。",
    "是的，我們支持靈活的工作模式，包括遠端工作，以平衡員工的工作與生活。",
    "我們提供2年的保固服務，並為所有產品提供免費的技術支援和軟體更新。",
    "有，我們的企業文化鼓勵多元化，並尊重來自不同背景的員工，創造包容的工作環境。",
    "去年我們的年營業額超過5億美元，並且每年保持穩定的增長。",
    "我們採用最先進的加密技術來保護用戶數據，並定期進行安全審查以防範任何潛在的威脅。",
    "我們每年參加多個全球領先的科技展覽，包括CES和MWC，展示最新的技術和產品。",
    "我們提供競爭力的薪酬，並包括醫療保險、年假、退休計畫等全面的員工福利。",
    "是的，我們的會員計畫提供專屬折扣、早期試用新品以及延長保固服務。",
    "我們積極參與社會公益活動，並通過“科技改變未來”計劃支持教育、環保等公益事業。"
]
